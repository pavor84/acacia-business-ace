 ...
 * @author Miro
 */
public class AbstractEntityPanel<E extends DataObjectBean, I extends DataObjectBean> extends AcaciaPanel {
    ...
    private void init() {
        ...
        if (!containers.containsKey("")) {
            throw new EntityPanelException("The mainContainer can not be null. The com.cosmos.acacia.annotation.Form is required.");
        }
        ...
        if (containers.size() > 0) {
            for (FormContainer formContainer : formContainers) {
                ...
                if (parentContainer == null) {
                    throw new EntityPanelException("Missing container with name: " + parentContainerName);
                }
    ...
    private JComponent getComponent(Component component, Field field) {
        ...
        try {
            ...
            throw new EntityPanelException("Can not create instance of " + componentClass, ex);
        }
        String text;
...
//            System.out.println("name=" + component.getName() + ", component=" + component);
//        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        AbstractEntityPanel<PurchaseInvoice, PurchaseInvoiceItem> entityPanel =
                new AbstractEntityPanel<PurchaseInvoice, PurchaseInvoiceItem>(invoice);
