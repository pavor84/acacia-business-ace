...
import org.jdesktop.swingx.JXPercentField;

/**
 *
 * @author Miro
 */
public class JBPercentField extends JXPercentField implements Validatable {

    public JBPercentField() {
    }

    public JBPercentField(BigDecimal value) {
        super(value);
    }
