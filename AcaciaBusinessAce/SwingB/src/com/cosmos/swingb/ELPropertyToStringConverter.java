 ...
 * @author Miro
 */
public class ELPropertyToStringConverter extends BeanResourceToStringConverter {

    /**
     * Default constructor
     */
    public ELPropertyToStringConverter() {
    }
     ...
     */
    public ELPropertyToStringConverter(ELProperty elProperty) {
     ...
     */
    public ELPropertyToStringConverter(String elPropertyExpression) {
