...
@rem %pgsql_path%\psql -q -W -U postgres -h localhost -d acacia -f acacia-ddl-2008-07-29.sql
%pgsql_path%\psql -q -W -U postgres -h 10.20.30.1 -d acacia -f acacia-ddl-2008-07-29.sql
