...
var regions = [
  {
  	title: "Aquarium",
  	href:  "http://blogs.sun.com/theaquarium/",
  	match: []
  },
  {
  	title: "Core",
  	...
  	match: [
  	  "https://migrate2glassfish.+",
  	  "https://glassfish-repo.+"
  	],
  	children: [
  		makeProjectLink("GlassFish"),
  		{ title: "Samples", href: "https://glassfish-samples.dev.java.net/" },
  		makeProjectLink("Grizzly"),
  		{ title: "Scripting", href: "https://glassfish-scripting.dev.java.net/" },
  		{ title: "OpenMQ", href: "https://mq.dev.java.net/" },
  		makeProjectLink("SailFin"),
  		makeProjectLink("Shoal"),
  		makeProjectLink("HK2"),
  		{ title: "Wiki", href: "http://wiki.glassfish.java.net/" }
  	]
  },
  {
  	title: "Webtier",
  ...
  {
	title: "Tools",
  	href:  "https://glassfish.dev.java.net/", /*TODO*/
  	match: [],
  	children: [
  		makeProjectLink("Hudson"),
  		makeProjectLink("Japex"),
  		makeProjectLink("openInstaller"),
  		{ title: "IDE Plugins", href: "https://glassfishplugins.dev.java.net/" },
        makeProjectLink("WSMonitor"),
