 ...
 */
public class AcaciaApplicationViewOld extends FrameView {

    @EJB
    private WarehouseListRemote warehouseBean;
    protected static Logger log = Logger.getLogger(AcaciaApplicationViewOld.class);

    public AcaciaApplicationViewOld(SingleFrameApplication app) {
        super(app);
        setLookAndFeel();
    }
