...
//        binding = new AcaciaLookupBinding(updateStrategy, beanEntity, elProperty, this, targetProperty);
    ...
    private void initComponents() {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(
            com.cosmos.acacia.crm.gui.AcaciaApplication.class).getContext().getActionMap(
            AcaciaLookup.class, this);
        button.setAction(actionMap.get("onSelect")); // NOI18N
        button.setIcon(resourceMap.getIcon("button.icon")); // NOI18N
        button.setText(resourceMap.getString("lookup.selectButton.text")); // NOI18N
            ...
            javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(
                    ...
                    layout.createSequentialGroup()
                            .addComponent(field, javax.swing.GroupLayout.DEFAULT_SIZE, 314,
                                Short.MAX_VALUE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(button, javax.swing.GroupLayout.PREFERRED_SIZE, 80,
                                javax.swing.GroupLayout.PREFERRED_SIZE)));
        layout.setVerticalGroup(layout.createParallelGroup(
            javax.swing.GroupLayout.Alignment.LEADING).addGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE).addComponent(
                field, javax.swing.GroupLayout.DEFAULT_SIZE, 20, Short.MAX_VALUE).addComponent(
                button, 0, 22, Short.MAX_VALUE)));
