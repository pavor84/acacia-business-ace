 ...
 * @author  daniel
 */
public class DeliveryCertificateSerialNumbersListPanel extends AbstractTablePanel<DeliveryCertificateSerialNumber> {
    ...
    @Override
    public boolean canModify(DeliveryCertificateSerialNumber rowObject) {
        return false;
    }

    @Override
    public boolean canDelete(DeliveryCertificateSerialNumber rowObject) {
        return true;
    }
    ...
    @Override
    protected boolean deleteRow(DeliveryCertificateSerialNumber rowObject) {
        if (rowObject != null) {
    ...
    @Override
    protected DeliveryCertificateSerialNumber modifyRow(DeliveryCertificateSerialNumber rowObject) {
        throw new UnsupportedOperationException("Not supported.");
    }

    @Override
    protected DeliveryCertificateSerialNumber newRow() {
        throw new UnsupportedOperationException("Not supported.");
    }
}
